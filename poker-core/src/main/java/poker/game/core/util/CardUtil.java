...
public final class CardUtil {
     ...
     */
    public static boolean ofAKind(final int ofAKind,
     ...
     * the BiPredicate matches on the current and the next card
     */
    public static boolean reduceToBoolean(final BiPredicate<Card, Card> predicate,
                                          final List<Card> cardList) {
